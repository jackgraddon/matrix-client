...
export default defineEventHandler(async (event) => {
    try {
        ...
        authorizationUrl.searchParams.set('state', 'random_state_string'); // TODO: Generate random state
        authorizationUrl.searchParams.set('nonce', 'random_nonce_string'); // TODO: Generate random nonce
