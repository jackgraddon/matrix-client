<template>
  <div class="space-y-4">
    ...
    <div>
      ...
      <div class="flex items-center gap-4 p-4 rounded-md border max-w-[50%]">
        ...
        <UiButton v-if="jellyfinStore.isAuthenticated" variant="outline" size="sm" @click="jellyfinStore.logout">
          Unlink
        </UiButton>
        <UiButton v-else variant="outline" @click="isJellyfinModalOpen = true">
          Link Jellyfin
        </UiButton>
      </div>
    </div>
